...
class InputEmbeddings(nn.Module):
    ...
    def forward(self, x):
        # scale by sqrt(d_model) according to the paper
...
class PositionalEncoding(nn.Module):
    def __init__(self, d_model: int, seq_len: int, dropout: float):
        ...
        # keep tensor in module, but not as a parameter
...
class LayerNormalization(nn.Module):
    ...
    def forward(self, x):
        # keep the dimensions for brodcasting 
...
class ResidualConnection(nn.Module):
    ...
    def forward(self, x, sublayer):
        # the paper first applies sublayer and then norm
        # we do the opposite for improved training stability
